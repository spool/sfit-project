# Django settings for sfit project.
import os
...
DATABASES = {
	...
	# 'NAME': '/var/www/vhosts/complex.org.uk/subdomains/sfit/apps/sfit-project/sfit/db/live.db',
...
SECRET_KEY = 'w-4hjpx^j#udadizvbawkca6f-lxt^ys%vn3vlc$dr+-_k8f17'
